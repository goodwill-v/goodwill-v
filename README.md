...
## ⭐ Избранные проекты
- **rusalts** — AI‑платформа и контент‑конвейер для задач адаптации к изменениям в регулировании ФЗ: ассистент, парсинг, публикации (сайт, соцсети) и инфраструктура деплоя.
